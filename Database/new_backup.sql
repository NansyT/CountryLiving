...
-- Started on 2020-06-15 08:35:35
...
--
-- TOC entry 232 (class 1255 OID 24609)
...
--
-- TOC entry 234 (class 1255 OID 24678)
...
--
-- TOC entry 236 (class 1255 OID 24662)
-- Name: fc_getavailableroom(date, date, character varying, character varying, character varying, character varying, character varying, character varying, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.fc_getavailableroom(datein date, dateout date, par1 character varying, par2 character varying, par3 character varying, par4 character varying, par5 character varying, par6 character varying, par7 character varying) RETURNS TABLE(roomid integer, services character varying, priceday numeric, totalprice numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
	RETURN QUERY
	...
	LEFT JOIN public.additional_services
	ON additional_services.pk_supplement_id = roomservices.pk_fk_supplement_id
	CROSS JOIN FC_CalculateTotalPrice(datein, dateout, RoomFunc.RoomID) AS totalpricetable
	GROUP BY RoomFunc.RoomID, room.price, totalpricetable.totalpricetable ;
END; $$;


ALTER FUNCTION public.fc_getavailableroom(datein date, dateout date, par1 character varying, par2 character varying, par3 character varying, par4 character varying, par5 character varying, par6 character varying, par7 character varying) OWNER TO postgres;

--
-- TOC entry 238 (class 1255 OID 24677)
...
--
-- TOC entry 237 (class 1255 OID 24676)
...
CREATE FUNCTION public.fc_getroomid(datein character varying, dateout character varying, par1 character varying, par2 character varying, par3 character varying, par4 character varying, par5 character varying, par6 character varying, par7 character varying) RETURNS TABLE(roomid integer)
    ...
    AS $$
BEGIN
RETURN QUERY SELECT CAST(pk_room_id as INTEGER)
	FROM room 
	...
	WHERE COALESCE(booking.check_out_date, '9999-12-31') >= CAST(dateout as date)
		...
		AND additional_services.description IN 
		(
			par1,
			par2,
			par3,
...
--
-- TOC entry 233 (class 1255 OID 24612)
...
--
-- TOC entry 2879 (class 0 OID 16802)
-- Dependencies: 207
...
--
-- TOC entry 2878 (class 0 OID 16773)
-- Dependencies: 206
...
--
-- TOC entry 2875 (class 0 OID 16752)
-- Dependencies: 203
...
--
-- TOC entry 2876 (class 0 OID 16760)
-- Dependencies: 204
...
--
-- TOC entry 2877 (class 0 OID 16768)
-- Dependencies: 205
...
--
-- TOC entry 2880 (class 0 OID 16810)
-- Dependencies: 208
...
--
-- TOC entry 2881 (class 0 OID 24669)
-- Dependencies: 209
...
--
-- TOC entry 2742 (class 2606 OID 16809)
...
--
-- TOC entry 2740 (class 2606 OID 16781)
...
--
-- TOC entry 2734 (class 2606 OID 16759)
...
--
-- TOC entry 2736 (class 2606 OID 16767)
...
--
-- TOC entry 2738 (class 2606 OID 16772)
...
--
-- TOC entry 2744 (class 2606 OID 16814)
...
--
-- TOC entry 2746 (class 2606 OID 16787)
...
--
-- TOC entry 2745 (class 2606 OID 16782)
...
--
-- TOC entry 2747 (class 2606 OID 16815)
...
--
-- TOC entry 2748 (class 2606 OID 16820)
...
-- Completed on 2020-06-15 08:35:36
